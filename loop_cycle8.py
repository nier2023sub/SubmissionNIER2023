...
tot_train_examples = 0

Xtrain = Xtest[indexes_df]
ytrain = ytest[indexes_df]
...
indexes_df = genfromtxt("Cycle6/rep"+rep+"/sel_indexes.csv",delimiter=',',dtype=int)
...
# history = model.fit(Xtrain_reshaped, y_train_cat, validation_data=(Xval_reshaped, y_val_cat), epochs=15,batch_size=128,shuffle=True)

# model.save(path+"modelC_loop_mutation.h5")
model = load_model("Cycle7/rep"+rep+"/modelC_loop_mutation.h5")
